...
declare_id!("8smQAHssVTo3k2k2qMihXwwU5Wmww9WbdSd6PEQ1Abo4");
...
pub struct Initialize<'info> {
    ...
    #[account(mut)]
    pub payer: Signer<'info>, // specify account must be signer on the transaction

    // The counter account being created and initialized in the instruction
    #[account(
        init,         // specifies we are creating this account
        payer = payer, // specifies account paying for the creation of the account
